...
function initLIFChart() {
    ...
    lifChart = new Chart(ctx, {
        ...
        options: {
            ...
            scales: {
                x: {
                    title: { display: true, text: 'Time (ms)', color: document.body.getAttribute('data-theme')==='dark' ? '#8892b0' : '#4b5563', font: { family: 'Inter', size: 10 } },
                ...
                y: {
                    title: { display: true, text: 'Voltage (mV)', color: document.body.getAttribute('data-theme')==='dark' ? '#8892b0' : '#4b5563', font: { family: 'Inter', size: 10 } },
                    grid: { color: document.body.getAttribute('data-theme')==='dark' ? 'rgba(74, 158, 255, 0.08)' : 'rgba(224, 212, 255, 0.4)' },
                    ticks: { color: document.body.getAttribute('data-theme')==='dark' ? '#8892b0' : '#4b5563' },
                    suggestedMin: -50,
                    suggestedMax: 600
